...
class SmartAgent(object):
    ...
    def __init__(self, action_size, observation_size):
        ...
        self.modelCopy = self.buildNeuralNetwork(self.observation_size, self.action_size)
    ...
    def act(self, observation):
        ...
        real_action = self.getRealAction(actionHighestPrediction)
        return real_action

    def getRealAction(self, action):
        #Convert real action, to conform to gym environment
        if action == 0:
            real_action = 1
        elif action == 1:
            real_action = 2
...
if __name__ == '__main__':
    ...
    try:
        ...
        observation_size = env.observation_space.shape[0] * env.observation_space.shape[1] #TODO Calculate size in a function
